...
namespace tookcar
{
    public partial class garageupdate : Form
    {
        public garageupdate()
        {
            InitializeComponent();
        ...
        private void search_Click(object sender, EventArgs e)
        {
            ...
            string query3 = $"SELECT * FROM garagedet WHERE GarageID = '{ID}'";
            ...
            try
            {
                ...
                {
                    data.Read();
                    textBox1.Text = data["GarageID"].ToString();
                    textBox2.Text = data["Name"].ToString();
                    textBox3.Text = data["Description"].ToString();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are You Sure Delete This Record", "Delete Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                string ID = textBox5.Text;
                string query3 = $"DELETE garagedet WHERE GarageID = '{ID}'";
        ...
        private void addkids_Click(object sender, EventArgs e)
        {
...

            {
                ...
                if (MessageBox.Show("Are You Sure Update This Record", "Update Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    string query2 = $"UPDATE garagedet SET GarageID='{id}', Name ='{name}', Description='{description}',MobileNumber='{mobilenb}',Address='{address}' WHERE GarageID = '{id}' ";
        ...
        private void garageupdate_Load(object sender, EventArgs e)
        {
