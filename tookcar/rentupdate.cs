...
namespace tookcar
{
    public partial class rentupdate : Form
    {
        public rentupdate()
        {
            InitializeComponent();
        ...
        private void search_Click(object sender, EventArgs e)
        {
            ...
            string query3 = $"SELECT * FROM rentdet WHERE RefNumber = '{ID}'";
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are You Sure Update This Record", "Update Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                string query2 = $"UPDATE rentdet SET RefNumber='{refnb}', VehicleNumber ='{vehiclenb}', FullName='{name}',NIC='{nic}',LisenceNumber='{licnb}',Duration='{duration}', AdvancePay='{advance}', DateObtained='{obdate}', KMs='{km}', DelivaryDate='{delydate}', TotalKMs='{totalkm}',FullPayment='{fullpay}',VerifyStaff_ID='{staffid}' WHERE RefNumber = '{refnb}' ";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are You Sure Delete This Record", "Delete Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                string ID = textBox5.Text;
                string query3 = $"DELETE rentdet WHERE RefNumber = '{ID}'";
