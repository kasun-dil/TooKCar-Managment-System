...
namespace tookcar
{
    public partial class staffupdate : Form
    {
        ...
        private void search_Click(object sender, EventArgs e)
        {
            ...
            string query3 = $"SELECT * FROM staffdet WHERE StaffID = '{ID}'";
            ...
            try
            {
                ...
                {
                    data.Read();
                    textBox1.Text = data["StaffID"].ToString();
                    textBox2.Text = data["FirstName"].ToString();
                    textBox3.Text = data["SecondName"].ToString();
                    textBox8.Text = data["NIC"].ToString();
                    textBox6.Text = data["JobRoll"].ToString();
        ...
        private void addkids_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are You Sure Update This Record", "Update Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                string query2 = $"UPDATE Staffdet SET StaffID='{id}', FirstName ='{fname}', SecondName='{sname}',NIC='{nic}',JobRoll='{job}',JoinedDate='{jdate}',MobileNumber='{mobilenb}',Address='{address}' WHERE StaffID = '{id}' ";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are You Sure Delete This Record", "Delete Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                string ID = textBox5.Text;
                string query3 = $"DELETE staffdet WHERE StaffID = '{ID}'";
